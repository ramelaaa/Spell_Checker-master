...
#ifndef unordered_dictionary_set_cpp
#define unordered_dictionary_set_cpp
...
unordered_dictionary_set::unordered_dictionary_set() {};

unordered_dictionary_set::~unordered_dictionary_set() {};

void unordered_dictionary_set::load_user_file(const char* newfile)
{
...
void unordered_dictionary_set::load_dictionary(const char* newfile)
{
    std::ifstream wordfile(newfile);
    std::string line;
...
void unordered_dictionary_set::find_in_dictionary()
{
...
bool unordered_dictionary_set::is_good_match(std::string in_dict, std::string bad_word)
{
    int bookmark = 0;
...
void unordered_dictionary_set::find_correct_spellings()
{
    std::unordered_set<std::string>::const_iterator got;
...
void unordered_dictionary_set::swap_test()
{
...
void unordered_dictionary_set::print()
{
    for(int i = 0; i<results.size(); i++)
    {
...
void unordered_dictionary_set::perform_corrections()
{
    find_in_dictionary();
